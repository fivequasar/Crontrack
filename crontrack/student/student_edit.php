...
if(isset($_POST['Submit'])){
    ...
    if (!empty($_POST['username']) && !empty($_POST['home_address']) && !empty($_POST['email_address']) && !empty($_POST['contact_number'])  && !empty($_POST['passwordInput'])){
    ...
    if (($checker0 == 1 && $checker1 == 1 && $checker2 == 1 && $checker3 == 1)) {
        ...
        echo "One of your inputs is in a wrong format";
    }
...
?>
<form action="student_edit_password.php"><input type="submit" value="Change Password" /></form>
